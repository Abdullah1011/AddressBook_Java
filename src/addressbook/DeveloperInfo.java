...
public class DeveloperInfo extends javax.swing.JFrame {
    ...
    int level = 0;
    public DeveloperInfo(int value) {
        level = value;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/addressbook/pic/developer.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            String URL = "www.facebook.com/abdullah.al.mizan";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeveloperInfo(0).setVisible(true);
            }
        });
    }
