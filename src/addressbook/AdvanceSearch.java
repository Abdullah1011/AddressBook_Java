...
public class AdvanceSearch extends javax.swing.JFrame {
    ...
    public AdvanceSearch() {
        ...
        allOption_l.setText("Search by Name    Search by Phone   Search by Email   Search by Serial");
        
        
        // title_l.setText(title);
        try{
    ...
    private void initComponents() {
        ...
        allOption_l = new javax.swing.JLabel();
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 110, 20));

        a_search.setToolTipText("Enter Name/Phone/Email/Serial to Search Info");
        a_search.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                a_searchKeyReleased(evt);
            }
        });
        getContentPane().add(a_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, 370, -1));
        ...
        name_l.setForeground(new java.awt.Color(255, 102, 0));
        name_l.setText("___________________");
        getContentPane().add(name_l, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 110, 160, -1));
        ...
        phone_l.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        phone_l.setForeground(new java.awt.Color(255, 102, 0));
        phone_l.setText("___________________");
        getContentPane().add(phone_l, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 130, 160, -1));
        ...
        gender_l.setForeground(new java.awt.Color(255, 102, 0));
        gender_l.setText("___________________");
        getContentPane().add(gender_l, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 130, 160, -1));
        ...
        email_l.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        email_l.setForeground(new java.awt.Color(255, 102, 0));
        email_l.setText("___________________");
        getContentPane().add(email_l, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 110, 160, -1));
        ...
        location_l.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        location_l.setForeground(new java.awt.Color(255, 102, 0));
        location_l.setText("___________________");
        getContentPane().add(location_l, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 150, 160, -1));

        city_l.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        city_l.setForeground(new java.awt.Color(255, 102, 0));
        city_l.setText("___________________");
        getContentPane().add(city_l, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, 160, -1));
        ...
        allOption_l.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        allOption_l.setText("Search by Name");
        getContentPane().add(allOption_l, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, -1, -1));

        jLabel11.setText("Searching Option:");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 220, -1, -1));

        jLabel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Search Result", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14), new java.awt.Color(204, 255, 255))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, 500, 110));
    ...
    private void a_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_a_searchKeyReleased
       
     try{
            String sql = "select * from person where name =?";
            pst = conn.prepareStatement(sql);
            pst.setString(1, a_search.getText());
            rs = pst.executeQuery();
    ...
    }//GEN-LAST:event_a_searchKeyReleased
    ...
    private javax.swing.JLabel allOption_l;
